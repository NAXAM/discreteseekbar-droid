<img src="./art/repo_header.png" alt="DiscreteSeekBar for Xamarin.Android" width="728" />

# DiscreteSeekBar for Xamarin.Android
A Xamarin.Android binding library for [DiscreteSeekBar](https://github.com/AnderWeb/discreteSeekBar) library.
...
```
Install-Package Naxam.DiscreteSeekBar.Droid
```

## Usage

Plz follow the official guide [here](https://github.com/AnderWeb/discreteSeekBar).

## License

DiscreteSeekBar binding library for Android is released under the MIT license.
...
Follow us for the latest updates<br>[![Twitter URL](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=https://github.com/NAXAM/discreteseekbar-droid)
